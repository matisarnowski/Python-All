...
def wybrane_dzialanie():
    ...
    print('0 - dodawanie, 1 - odejmowanie, 2 - mnożenie, 3 - dzielenie, 4 - potęgowanie, 5 - pierwiastkowanie, 6 - reszta z dzielenia, 7 - dzielenie całkowite, 8 - opuszczenie programu ')
        ...
        if dzialanie == '0':
            ...
            while (liczba_1 < 0 and liczba_2 % 2 == 0) or liczba_2 == 0:
                if liczba_1 < 0 and liczba_2 % 2 == 0:
                    print('To nie zadziała na liczbach rzeczywistych, aby wyciągnąć pierwiastek stopnia parzystego z liczby ujemnej potrzebowalibyśmy liczb zespolonych. spróbuj jeszcze raz: ')
                    while True:
                        liczba_1 = float(input('Podaj pierwszą liczbę: '))
                        liczba_2 = float(input('Podaj drugą liczbę: '))
                        if isinstance(liczba_1, float) and isinstance(liczba_2, float) == True:
                    ...
                    print('Nie istnieje pierwiastek stopnia zerowego. Spróbuj jeszcze raz: ')
                    while True:
                        liczba_1 = float(input('Podaj pierwszą liczbę: '))
                        liczba_2 = float(input('Podaj drugą liczbę: '))
                        if isinstance(liczba_1, float) and isinstance(liczba_2, float) == True:
